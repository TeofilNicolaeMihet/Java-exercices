...
//        adelaideCrows.addPlayer(beckam);
        ...
        System.out.println("Adelaide Crows player count: " + adelaideCrows.numPlayers());

        Team<BaseballPlayer> chicagoCubs = new Team<>("Chicago Cubs");
        chicagoCubs.addPlayer(pat);
//        chicagoCubs.addPlayer(beckam);

        Team<SoccerPlayer> arsenalFC = new Team<>("Arsenal FC");
        arsenalFC.addPlayer(beckam);
